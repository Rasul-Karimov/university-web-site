        ...
        <div className="about__specialties container">
          ...
          <div className="about__specialties-items ">
            <ItemSpecialties
              ...
              text="  в котором студенты могут обучаться, с присвоением академической степени
        бакалавр по направлениям: 710300 Прикладная информатика; 710200
        Информационные системы и технологии; 590100 Информационная безопасность;
        710500 Интернет-технологии и управление; Место для обучения, открытий,
        инноваций, самовыражения и общения"
            />
            <ItemSpecialties
              title="IT - колледж"
              text="  в котором студенты могут обучаться, с присвоением академической степени
